...
public class App extends Application {
  ...
  public GetStatusRec getStatusRec = new GetStatusRec();
    ...
    registerReceiver(getStatusRec, new IntentFilter("com.swiftsku.swiftscale.GET_VPN_STATUS"));
	}
  ...
  public void broadcastVPNStatus(boolean status) {
    vpnStatus = status;
    Intent stateIntent = new Intent("com.swiftsku.swiftscale.VPN_STATUS");
...
class GetStatusRec extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    if (intent.getAction().equals("com.swiftsku.swiftscale.GET_VPN_STATUS")) {
