...
public class IPNService extends VpnService {
	public static final String ACTION_CONNECT = "com.swiftsku.swiftscale.CONNECT";
	public static final String ACTION_DISCONNECT = "com.swiftsku.swiftscale.DISCONNECT";
